...
class BaseConfig(object):
    ...
    ADMIN_ACCOUNT = 'adminuseraccount@gmail.com'

    # Logging
    # TO DO: log to syslog instead?
    LOG_LEVEL = 'INFO'
    LOG_FOLDER = '/var/log/ammcon-frontend'
    ...
    # SQLAlchemy
    SQLALCHEMY_DATABASE_URI = 'sqlite:///{}'.format(os.path.join(LOCAL_PATH, 'flask_db.sqlite'))
    SQLALCHEMY_BINDS = {
        'device_logs': 'sqlite:///{}'.format(os.path.join(LOCAL_PATH, 'devices_db.sqlite'))
    }
